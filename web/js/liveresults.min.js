...
{if(updateAutomatically)
{$.ajax({url:"api.php",data:"comp="+_compId+"&method=getlastpassings&lang="+_lang+"&last_hash="+lastPassingsUpdateHash,success:resp_updateLastPassings,error:function(){passingsUpdateTimer=setTimeout(updateLastPassings,updateInterval);},dataType:"json"});}};resp_updateLastPassings=function(data)
{if(data!=null&&data.status=="OK")
